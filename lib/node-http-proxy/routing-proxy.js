...
var RoutingProxy = exports.RoutingProxy = function (options) {
  ...
  if (options.router) {
    ...
    this.routeNotFound = options.routeNotFound;
  }
...
RoutingProxy.prototype.proxyRequest = function (req, res, options) {
  ...
  if (this.proxyTable && !options.host) {
    ...
    // 
    // If no location is returned trying fallback 
    // to an optional resolver function
    // 
    if (!location && this.routeNotFound) {
      location = this.routeNotFound(req);
    }
